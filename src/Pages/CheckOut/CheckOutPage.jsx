    ...
    <Box sx={{ padding: "20px" }}>
      ...
      <Grid container spacing={3} mt={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <form>
            ...
            <TextField
              ...
              onChange={(e) => setBillingDetails({ ...billingDetails, town: e.target.value })}
              sx={{ marginBottom: "15px" }}
              required
            />
            <TextField
        ...
        <Grid item xs={12} md={6}>
          ...
          <Table sx={{ tableLayout: "auto",width:"85%" }}>
            <TableBody>
                <TableRow >
                  ...
                  <TableCell align="right">
                    <Typography><span style={{textDecoration:"underline"}}>${total}</span></Typography>
                  </TableCell>
                </TableRow>
            </TableBody>
          </Table>
          ...
          />
          <Button variant="contained" sx={{ marginTop: "6px",marginLeft:3, backgroundColor: "#DB4444", }}>Apply Coupon</Button>
     <p></p>
          {/* Place Order Button */}
          <Button
            variant="contained"
...
>
  <Fade in={modalOpen}>
    ...
    >
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right"><strong>Information</strong></TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {/* Billing Details */}
          <TableRow>
            ...
            <TableCell align="right">{billingDetails.firstName}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Company Name</TableCell>
            <TableCell align="right">{billingDetails.companyName}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Street Address</TableCell>
            <TableCell align="right">{billingDetails.streetAddress}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Apartment</TableCell>
            <TableCell align="right">{billingDetails.apartment || "N/A"}</TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell align="right">{billingDetails.phoneNumber}</TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell align="right">{paymentMethod === "bank" ? "Bank Transfer" : "Cash on Delivery"}</TableCell>
          </TableRow>
      ...
      <Button
        variant="contained"
        sx={{ marginTop: "15px", backgroundColor: "#DB4444", color: "white" }}
